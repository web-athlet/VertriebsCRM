...
const LayoutProvider = ({ children }: ChildrenType) => {
  ...
  const INIT_STATE: LayoutState = {
    ...
    menu: {
      ...
      size: queryParams['menu_size'] ? (queryParams['menu_size'] as MenuType['size']) : 'sm-hover',
    },
  }
  ...
  // Remove splash screen only after LayoutProvider has mounted and applied
  // theme attributes — this guarantees the page is fully ready to display.
  useEffect(() => {
